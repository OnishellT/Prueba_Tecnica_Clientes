				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Manejar Clientes</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Manejar Clientes </h3>
						<div class="graph">
							<div class="tables">
									     ...
									     <tr class="active">
									      <th scope="row"><?php echo htmlentities($cnt);?></th>
									       <td><?php  echo htmlentities($row->AccountID);?></td>
									        ...
									        <td><a href="edit-client-details.php?editid=<?php echo $row->ID;?>">Editar</a>  ||  <a href="add-client-services.php?addid=<?php echo $row->ID;?>">Assignar Servicios</a></td>
									     </tr>
									     <?php $cnt=$cnt+1;}} ?>
									     </tbody> </table> 
							</div>
