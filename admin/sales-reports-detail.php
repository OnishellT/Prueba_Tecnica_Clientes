			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Reportes de Ventas  </h3>
						<div class="graph">
							<div class="tables">
								 <?php
...
$y2=date("Y",$month2);
    ?>
<h4 class="header-title m-t-0 m-b-30">Ventas Mensuales </h4>
<h4 align="center" style="color:blue">Ventas desde  <?php echo $m1."-".$y1;?> to <?php echo $m2."-".$y2;?></h4>
<hr />
...
$y2=date("Y",$year2);
 ?>
 <h4 class="header-title m-t-0 m-b-30">Ventas Anuales </h4>
    <h4 align="center" style="color:blue">Venntas desde <?php echo $y1;?> to <?php echo $y2;?></h4>
    <hr /> 
    <table class="table" border="1"> <thead> <tr>  
									<th>S.NO</th>
<th>Month / Year </th>
