		...
		<div class="error-top">
			<div class="login">
				...
				<form id="login" method="post" name="login"> 
					...
					<input type="password" value="Contraseña " onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Contraseña';}" name="password" required="true">
					<div class="submit"><input type="submit" onclick="myFunction()" value="Iniciar Sesion" name="login" ></div>
					<div class="clearfix"></div>

					<div class="new">
						<p><a href="forgot-password.php">Olvido su Contraseña?</a></p><br />
						<p><a class href=""></a></p>
						<div class="clearfix"></div>
					</div>
				</form>
